...
AddOutputFilter chunkFilter
		...
		<Item Name="ARM Controller (SubVI).vi" Type="VI" URL="../../../SubVi/ARM Controller (SubVI).vi"/>
		<Item Name="arm_kinematics (SubVI).vi" Type="VI" URL="../../../SubVi/arm_kinematics (SubVI).vi"/>
		<Item Name="Rectangle Set (SubVI).vi" Type="VI" URL="../../../SubVi/Rectangle Set (SubVI).vi"/>
		<Item Name="Untitled 3.vi" Type="VI" URL="../../../SubVi/Untitled 3.vi"/>
		<Item Name="test1.vi" Type="VI" URL="../test1.vi"/>
		<Item Name="edit1.vi" Type="VI" URL="../edit1.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="A_ENC (SubVI).vi" Type="VI" URL="../../../SubVi/Express to sub/A_ENC (SubVI).vi"/>
			<Item Name="B_ENC (SubVI).vi" Type="VI" URL="../../../SubVi/Express to sub/B_ENC (SubVI).vi"/>
			...
			<Item Name="C0_ENC (SubVI).vi" Type="VI" URL="../../../SubVi/Express to sub/C0_ENC (SubVI).vi"/>
			<Item Name="C1_ENC (SubVI).vi" Type="VI" URL="../../../SubVi/Express to sub/C1_ENC (SubVI).vi"/>
			...
			<Item Name="Navx-open (SubVI).vi" Type="VI" URL="../../../SubVi/Navx-open (SubVI).vi"/>
			<Item Name="Navx-Read (SubVI).vi" Type="VI" URL="../../../SubVi/Navx-Read (SubVI).vi"/>
			...
			<Item Name="Sharp Read (SubVI).vi" Type="VI" URL="../../../SubVi/Express to sub/Sharp Read (SubVI).vi"/>
			<Item Name="torque-write (SubVI).vi" Type="VI" URL="../../../SubVi/Dynamixel/torque-write (SubVI).vi"/>
			<Item Name="Encoder (SubVI).vi" Type="VI" URL="../../../SubVi/Encoder (SubVI).vi"/>
			<Item Name="LED (SubVI).vi" Type="VI" URL="../../../SubVi/LED (SubVI).vi"/>
			<Item Name="Set (SubVI).vi" Type="VI" URL="../../../SubVi/Set (SubVI).vi"/>
			<Item Name="Movement (SubVI).vi" Type="VI" URL="../../../SubVi/Movement (SubVI).vi"/>
			<Item Name="Sharp (SubVI).vi" Type="VI" URL="../../../SubVi/Sharp (SubVI).vi"/>
			<Item Name="S10.vi" Type="VI" URL="../../../Vision Vi/S10.vi"/>
			<Item Name="Speed Position (SubVI).vi" Type="VI" URL="../../../SubVi/Dynamixel/Speed Position (SubVI).vi"/>
			<Item Name="M30.vi" Type="VI" URL="../../../Vision Vi/M30.vi"/>
			<Item Name="pbb.vi" Type="VI" URL="../../../Vision Vi/pbb.vi"/>
			<Item Name="motor.vi" Type="VI" URL="../../../Vision Vi/motor.vi"/>
			<Item Name="M20.vi" Type="VI" URL="../../../Vision Vi/M20.vi"/>
			<Item Name="psk.vi" Type="VI" URL="../../../Vision Vi/psk.vi"/>
			<Item Name="ps10.vi" Type="VI" URL="../../../Vision Vi/PTT/ps10.vi"/>
			<Item Name="pm30.vi" Type="VI" URL="../../../Vision Vi/PTT/pm30.vi"/>
			<Item Name="pm20.vi" Type="VI" URL="../../../Vision Vi/PTT/pm20.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build"/>
	</Item>
</Project>
