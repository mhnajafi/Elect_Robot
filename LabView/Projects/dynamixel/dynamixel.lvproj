...
AddOutputFilter chunkFilter
		...
		<Item Name="LED (SubVI).vi" Type="VI" URL="../../../SubVi/Dynamixel/LED (SubVI).vi"/>
		<Item Name="Main.vi" Type="VI" URL="../Main.vi"/>
		<Item Name="Position-write (SubVI).vi" Type="VI" URL="../../../SubVi/Dynamixel/Position-write (SubVI).vi"/>
		<Item Name="Speed Position (SubVI).vi" Type="VI" URL="../../../SubVi/Dynamixel/Speed Position (SubVI).vi"/>
		<Item Name="torque-write (SubVI).vi" Type="VI" URL="../../../SubVi/Dynamixel/torque-write (SubVI).vi"/>
		<Item Name="Dependencies" Type="Dependencies">
